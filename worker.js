    ...
    if (path === "/proxy") {
      ...
      try {
        ...
        if (contentType.includes("mpegurl") || contentType.includes("application/vnd.apple.mpegurl") || targetUrl.includes(".m3u8")) {
          ...
          const channelId = mainUrlObj.searchParams.get("id"); // Menghasilkan 'rcti', 'mnctv', dll.
          ...
          // Tentukan domain pengganti di luar loop agar performa lebih cepat
          // Jika id tidak ditemukan di mapping, gunakan rcti sebagai fallback default
          ...
          const modifiedLines = lines.map(line => {
            ...
            // PROSES PEMBONGKARAN: Tukar domain r-plus dengan targetDomain yang sudah pas di awal
